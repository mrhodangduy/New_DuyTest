...
class Offline_OverviewVC: UIViewController {
    ...
    {
        examIDLabel.text = Exam.examName
        
        if (Exam.examQuestionaireThree) == nil
        {
        ...
        if ((Exam.examQuestionaireOne)?.hasPrefix("http://wodule.io/user/")) == true
        {
        ...
        if ((Exam.examQuestionaireTwo)?.hasPrefix("http://wodule.io/user/")) == true
        {
        ...
        if ((Exam.examQuestionaireThree)?.hasPrefix("http://wodule.io/user/")) == true
        {
        ...
        if ((Exam.examQuestionaireFour)?.hasPrefix("http://wodule.io/user/")) == true
        {
...
extension Offline_OverviewVC: AVAudioPlayerDelegate
{
