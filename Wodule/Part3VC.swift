...
class Part3VC: UIViewController {
    ...
    @IBAction func nextBtnTap(_ sender: Any) {
        ...
        else
        {
            ...
            part4_tempVC.audio1_Path = self.audio1_Path
            part4_tempVC.audio2_Path = self.audio2_Path
            part4_tempVC.audio3_Path = self.audio3_Path
        ...
        UIView.animate(withDuration: expectTime, animations: {
            ...
            if self.Exam?["question_4"] as? String == nil && self.Exam?["image_4"] as? String == nil
            {
                ...
                do
                {
                    ...
                    ExamRecord.uploadExam(withToken: self.token!, idExam: self.examID, audiofile1: data1, audiofile2: data2, audiofile3: data3, audiofile4: nil, completion: { (status:Bool?, result:NSDictionary?) in
                        if status!
                        {
